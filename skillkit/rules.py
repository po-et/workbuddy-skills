...
PITFALLS = (
    ...
    {
        "id": "downloads-are-exposure",
        "现象": "上架很久也没量，热榜技能一天却涨几千",
        "规则": "downloads = 全员抓取基线（约 +4/天，与内容无关）+ 榜单曝光（在榜中位 +340/6h，不在榜 +1/6h）；"
                "与质量分、触发面、上架时长都无关，hot 榜按下载排序、回路自我强化，入口只能来自平台外",
        "证据": "2026-09-18~21 四天 321 组 updated_at 配对 0 例外；09-21 在榜 105 vs 只在 newest 榜 99 个新技能同窗口对照"
                "（docs/metrics/2026-09-21-曝光假说检验.md）",
        "置信度": "实测（四天）",
        "skillkit": "stats 把 downloads 当抓取/曝光计数报，不当用户行为解释；真实采用看 installs，人气看 stars",
    },
    {
