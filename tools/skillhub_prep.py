...
SLUGS = {
    ...
    "skill-author-expert": "skill-author-expert",
    "agent-engineering-expert": "agent-engineering-expert",
    "financial-literacy-expert": "financial-literacy-expert",
    "insurance-policy-expert": "insurance-policy-expert",
    "tax-filing-expert": "tax-filing-expert",
    "personal-budget-expert": "personal-budget-expert",
    "travel-planner-expert": "travel-planner-expert",
    "exam-prep-expert": "exam-prep-expert",
    "workplace-antiscam-expert": "workplace-antiscam-expert",
    "presentation-expert": "presentation-expert",
    "gov-doc-expert": "gov-doc-expert",
    "resume-job-expert": "resume-job-expert",
    "career-growth-expert": "career-growth-expert",
    "tech-writing-expert": "tech-writing-expert",
    "tech-interview-expert": "tech-interview-expert",
    "architect-expert": "architect-expert",
    "qa-expert": "qa-expert",
    "sre-expert": "sre-expert",
    "container-deploy-pro": "container-deploy-pro",
    "api-integration-pro": "api-integration-pro",
    "incident-response-pro": "incident-response-pro",
    "data-toolkit-pro": "data-toolkit-pro",
    "repo-governance-pro": "repo-governance-pro",
    "database-ops-pro": "database-ops-pro",
    "skillhub-field-guide": "skillhub-field-guide",
...
TAGS = {
    ...
    "skill-author-expert": ["技能开发", "SKILL.md", "SkillHub", "技能发布", "触发面设计", "slug 命名", "发布配额", "上架数据"],
    "agent-engineering-expert": ["Agent 工程", "提示词", "上下文工程", "技能开发", "SKILL.md", "子代理编排", "工具设计", "上下文退化"],
    "financial-literacy-expert": ["理财常识", "年化收益", "复利", "费率", "基金合同", "风险等级", "投资话术", "防坑"],
    "insurance-policy-expert": ["保单", "保险条款", "免责条款", "健康告知", "理赔", "拒赔", "退保", "保证续保"],
    "tax-filing-expert": ["个税", "年度汇算", "退税", "补税", "专项附加扣除", "年终奖计税", "劳务报酬", "个人所得税App"],
    "personal-budget-expert": ["记账", "预算", "攒钱", "存钱", "还债", "债务优先级", "月光", "家庭账本"],
    "travel-planner-expert": ["旅行规划", "自由行", "行程安排", "亲子出行", "带老人旅行", "签证准备", "旅行预算", "出行避坑"],
    "exam-prep-expert": ["备考", "考研", "考公", "考编", "考证", "复习计划", "错题复盘", "时间管理"],
    "workplace-antiscam-expert": ["防骗", "招聘诈骗", "求职避坑", "培训贷", "刷单兼职", "冒充领导转账", "职场传销", "劳动合同"],
    "presentation-expert": ["汇报", "PPT", "演示", "故事线", "数据图表", "演讲", "答辩", "线上会议"],
    "gov-doc-expert": ["公文写作", "机关文稿", "请示报告", "会议纪要", "工作总结", "讲话稿", "述职报告", "文秘"],
    "resume-job-expert": ["求职", "简历", "面试", "跳槽", "谈薪", "offer", "转行", "职业规划"],
    "career-growth-expert": ["职业成长", "晋升", "绩效", "向上管理", "带人", "跳槽", "技术影响力", "职级"],
    "tech-writing-expert": ["技术写作", "技术方案", "周报", "述职", "晋升答辩", "故障复盘", "技术分享", "说人话"],
    "tech-interview-expert": ["技术面试", "简历", "系统设计", "手撕代码", "行为面试", "面试官", "offer", "谈薪"],
    "architect-expert": ["架构设计", "技术选型", "架构评审", "接口设计", "领域建模", "ADR", "技术债", "重构"],
    "qa-expert": ["测试", "QA", "用例设计", "接口回归", "flaky", "覆盖率", "压测", "上线验收"],
    "sre-expert": ["运维", "SRE", "oncall", "告警响应", "止损回滚", "容量压测", "证书巡检", "故障复盘"],
    "container-deploy-pro": ["容器部署", "Dockerfile", "Kubernetes", "上线检查", "nginx", "回滚", "证书巡检", "配置对齐"],
    "api-integration-pro": ["接口联调", "接口调试", "OpenAPI", "契约测试", "鉴权排错", "JWT", "抓包转代码", "接口兼容"],
    "incident-response-pro": ["故障排查", "告警响应", "止损", "日志分析", "时间线", "复盘", "根因定位", "SRE"],
    "data-toolkit-pro": ["CSV 画像", "数据质量", "JSON 对比", "JSON Schema", "正则", "脱敏", "密钥扫描", "日志聚类"],
    "repo-governance-pro": ["技术债", "代码评审", "分支清理", "代码热点", "提交规范", "CODEOWNERS", "PR 描述", "仓库治理"],
    "database-ops-pro": ["慢查询", "索引优化", "SQL 迁移", "锁表", "表结构对比", "数据库运维", "MySQL", "PostgreSQL"],
    "skillhub-field-guide": ["SkillHub", "发布配额", "发布频率过高", "限流退避", "slug 抢注", "发布节奏规划", "上架与评测", "下载量解读"],
